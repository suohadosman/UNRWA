$(document).ready(function () {
    $('#LabTestTypeId').on('change', function () {
        ...
        if (typeId !== '') {
            $.ajax({
                url: '/Doctor/PatientLabTestInType?personId=' + personId + '&typeId=' + typeId,
                success: function (result) {
                    ...
                    $.each(result, function (i, labtest) {
                        ...
                        var text1 = document.createTextNode(labtest.labTestTypeName);
                        var text2 = document.createTextNode(labtest.labTestName)
                        var text3 = document.createTextNode(labtest.date)
                        var text4 = document.createTextNode(labtest.result)
                        var text5 = document.createTextNode(labtest.unit)
                        ...
                        //To Do If (labtest.isDone)
                        //var icon = document.createElement("i");
                        //if (labtest.isAvilable) {
